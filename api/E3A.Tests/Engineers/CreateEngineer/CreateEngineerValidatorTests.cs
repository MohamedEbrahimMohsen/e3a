...
public sealed class CreateEngineerValidatorTests
{
    ...
    {
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, "Dive Backend Engineer", "A backend engineer.", ["dotnet", "ddd"]));
    ...
    {
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, displayName!, null, []));
    ...
    {
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, new string('a', 101), null, []));
    ...
    {
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, "مهندس", null, []));
    ...
    {
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, "Dive Backend Engineer", new string('a', 501), []));
    ...
    public void Validate_ShouldFail_WhenTagCountExceedsMaximum()
    {
        ...
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, "Dive Backend Engineer", null, tags));
    ...
    {
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, "Dive Backend Engineer", null, ["dotnet", "  "]));
    ...
    {
        var result = _sut.Validate(new CreateEngineerCommand(EngineerFactory.DefaultSlug, "Dive Backend Engineer", null, [new string('a', 31)]));
