...
public sealed class ProcessPublishJobHandlerFailureTests
{
    ...
    public ProcessPublishJobHandlerFailureTests()
    {
        ...
        _sut = new ProcessPublishJobHandler(_itemVersionRepository, _engineerRepository, _userRepository, _storageBlobClient, Options.Create(_azureOptions), Options.Create(PublishingOptionsFactory.Default()));
    }
