...
```
dotnet tool restore
dotnet user-secrets set "ConnectionStrings:DbConnectionString" "<connection string>" --project E3A.Api
dotnet ef database update --project E3A.Infrastructure --startup-project E3A.Api
dotnet run --project E3A.Api
```
