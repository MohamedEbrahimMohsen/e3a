...
public static class PublishStatusResultGenerator
{
    public static PublishStatusResult Generate(ItemVersion version, PublishingOptions options)
    {
        ...
        return new PublishStatusResult(version.Id, version.ItemId, version.VersionNumber, version.SemanticVersion, version.Status.ToString(), zipUrl, version.ZipSha256, version.SizeBytes, version.FailureReason, ScanReportSerializer.Deserialize(version.ScanReportJson), version.UpdationDate);
    }
}
